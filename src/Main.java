...
public class Main {
    ...
    public static void main (String[] args){
        ...
        while (again == 1){
            ...
            System.out.println("The number of games won any money: "+loop.getTotalWon());
            System.out.println("The number of games won all 6 numbers: "+loop.getTotalJackpot());
            ...
            System.out.print("Do you want get information about any specific match ? (Input match number from 1 to "+numberLoop+" OR 0 to exit): ");
